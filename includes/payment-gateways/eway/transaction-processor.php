...
if ( ! class_exists( Rapid::class ) ) {
    require WOO_MP_PATH . '/includes/payment-gateways/eway/libraries/eway-rapid-php-1.4.2/include_eway.php';
}
...
class Transaction_Processor extends \Woo_MP\Payment_Gateway\Transaction_Processor {
    ...
    public static function get_response_code_messages() {
        return parse_ini_file( WOO_MP_PATH . '/includes/payment-gateways/eway/libraries/eway-rapid-php-1.4.2/resource/lang/en.ini' );
    }
